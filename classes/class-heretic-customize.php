...
if ( ! class_exists( 'Heretic_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Twenty Twenty-One 1.0
	 */
	class Heretic_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'heretic' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'heretic' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'heretic' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'heretic' ),
						'full'    => esc_html__( 'Full text', 'heretic' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-heretic-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Heretic_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Heretic_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'heretic' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
